 ...
 * 
 */
UCLASS(const, hidecategories = Object, collapsecategories, meta = (DisplayName = "Unsheathe Weapon"))
class RPGPROJECT_API UAnimNotify_UnsheatheWeapon : public UAnimNotify
{
...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Notify")
	EWeaponToUse WeaponToUnsheathe;
