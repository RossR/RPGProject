...
#include "AbstractionInteractionComponent.generated.h"
...
class RPGPROJECT_API UAbstractionInteractionComponent : public UActorComponent
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	UAbstractionInteractionComponent();
